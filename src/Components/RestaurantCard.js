...
const RestaurantCard = (props) => {
    ...
    return (
        <div className={shouldEnableCarousel ? "h-92 w-60 p-2 m-2 hover:cursor-pointer hover:scale-95 rounded-md" : " w-60 h-92 p-2 m-2 hover:cursor-pointer hover:scale-95 overflow-hidden rounded-md"}>
